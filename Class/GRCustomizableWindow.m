...
//    [self drawTitleString];
    NSImageView *imaview  = [[NSImageView alloc] initWithFrame:NSMakeRect(100, 0, 300, 40)];
    NSImage *ima = [NSImage imageNamed:@"1.png"];
    imaview.image = ima;
    [ima drawInRect:NSMakeRect(100,NSHeight(self.frame)- _titlebarHeight, 300.f,40)];
}
...
{
    return NSHeight(self.frame)-NSHeight([self titlebarRect])/2-15;
}
